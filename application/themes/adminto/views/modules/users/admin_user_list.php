                                            ...
                                            <aside id="sidebar" class="nano">
                                                <div class="nano-content">
													...
													<!--<a href="/users/add" class="new-user btn btn-success pull-right btnAssign" data-ajax="true"><i class="fa fa-plus"></i> <span>Add user</span></a>-->
                                                        <a href="#custom-modal" class="btn btn-danger btn-rounded w-lg waves-effect waves-light m-b-20 m-t-30" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a"><i class="fa fa-plus"></i> New User</a>
                                                    </div>
                                                    <menu class="menu-segment">
                                                        <ul class="list-unstyled">
                                                            <li class="active"><a href="javascript:void(0);">Clients<span> (<?php echo $total; ?>)</span></a></li>
															<li><a href="javascript:void(0);">Paid</a></li>
                                                            <li><a href="javascript:void(0);">Trial</a></li>
                                                            <li><a href="javascript:void(0);">Expired</a></li>
                                                            <li><a href="javascript:void(0);">Drafts</a></li>
                                                            <li><a href="javascript:void(0);">Trash</a></li>
															<?php if ($current_user['is_super_admin'] == 1 || $current_user['is_super_admin'] == 3) {?><li><a href="javascript:void(0);">Resellers</a></li><?php } ?>
															<?php if ($current_user['is_super_admin'] == 1) {?><li><a href="javascript:void(0);">PLR</a></li><?php } ?>
                                                        </ul>
                                                    </menu>
                                                    <div class="separator"></div>
                                                    <div class="menu-segment">
                                                        <ul class="labels list-unstyled">
                                                            <li class="title">Type <span class="icon">+</span></li>
                                                            <li><a href="#">Reseller <span class="ball pink"></span></a></li>
                                                            <li><a href="#">Private Label <span class="ball orange"></span></a></li>
                                                    ...
                                                    <div class="menu-segment">
                                                        <ul class="chat list-unstyled">
                                                            <li class="title">Product <span class="icon">+</span></li>
                                                            <li><a href="#"><span class="ball green"></span>Text Marketing</a></li>
                                                            <li><a href="#"><span class="ball blue"></span>Live Chat</a></li>                                                           
                                            ...
                                            <main id="main">
                                                ...
                                                <header class="header">
                                                    ...
                                                    <div class="search-box pull-left">
                                                        <input type="text" name="s" id="s" placeholder="Search..." value="<?php echo $search; ?>"><span
                                                        ...
                                                        <ul class="message-list">
															...
															<li>
                                                                <div class="col col-1"><span class="dot"></span>
                                                                    ...
                                                                    <p class="title"><?php echo $item['email']; ?></p><span
                                                                            class="star-toggle fa fa-star-o"></span>
                                                                </div>
                                                                <div class="col col-2">
