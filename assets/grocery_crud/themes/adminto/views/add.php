<?php
    ...
    if ($this->config->environment == 'production') {
        ...
        $this->set_js_config($this->default_theme_path.'/adminto/js/form/add.min.js');
    } else {
        $this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
        ...
        $this->set_js_config($this->default_theme_path.'/adminto/js/form/add.js');
    }
            ...
            <div class="col-md-12">
				<div class="card-box">
					<div class="xtable-label">
						<div class="floatL l5">
							<h4 class="header-title m-t-0 m-b-30"><?php echo $this->l('form_add'); ?> <?php echo $subject?></h4>
						</div>
