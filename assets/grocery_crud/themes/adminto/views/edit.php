<?php
    ...
    $this->set_css($this->default_theme_path.'/adminto/css/add-edit-form.css');

    if ($this->config->environment == 'production') {
        $this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
        $this->set_js_lib($this->default_theme_path.'/adminto/build/js/global-libs.min.js');
        $this->set_js_config($this->default_theme_path.'/adminto/js/form/edit.min.js');
    } else {
        $this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
        $this->set_js_lib($this->default_theme_path.'/adminto/js/jquery-plugins/jquery.form.min.js');
        $this->set_js_lib($this->default_theme_path.'/adminto/js/common/common.min.js');
        $this->set_js_config($this->default_theme_path.'/adminto/js/form/edit.js');
    }
...
<div class="crud-form" data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="container gc-container">
        <div class="row">
            <div class="col-md-12">
				<div class="card-box">
					<div class="xtable-label">
						<div class="floatL l5">
							<h4 class="header-title m-t-0 m-b-30"><?php echo $this->l('form_edit'); ?> <?php echo $subject?></h4>
						</div>
